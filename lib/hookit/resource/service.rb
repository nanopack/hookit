    ...
    class Service < Base
      ...
      def enable!
        ...
        when :runit
          ...
          run_command! "sv #{"-w #{timeout}" start if timeout} #{service_name}", false
          ...
          if registered
            ...
            run_command! "sv #{"-w #{timeout}" start if timeout} #{service_name}"
          end
        end
      end
      ...
      def disable!
        ...
        when :runit
          run_command! "sv #{"-w #{timeout}" stop if timeout} #{service_name}"
        end
      end
